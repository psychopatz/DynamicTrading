...
-- Logic: Sequential Layout + Custom 'Clear' Behavior
-- =============================================================================
...
function PsychopatzDebugWindow:onExecute()
    ...
    if player then
        ...
        print("[PsychopatzDebug] Sending Command -> Item: " .. itemID .. " x" .. quantity)
