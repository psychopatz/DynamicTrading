...
{ item="Base.Bag_ToolBag",                  basePrice=200, tags={"Container.Backpack.Duffel", "Theme.Industrial", "Rarity.Common"}, stockRange={min=1, max=3} },
{ item="Base.Bag_WeaponBag",                basePrice=220, tags={"Container.Backpack.Duffel", "Origin.Military", "Rarity.Uncommon"}, stockRange={min=1, max=3} },
{ item="Base.Bag_WorkerBag",                basePrice=180, tags={"Container.Backpack.Duffel", "Theme.Industrial", "Rarity.Common"}, stockRange={min=1, max=3} },
...
{ item="Base.Bag_Schoolbag_Medical",        basePrice=140, tags={"Container.Backpack.Civ", "Origin.Medical", "Rarity.Uncommon"}, stockRange={min=2, max=5} },
...
{ item="Base.Bag_Satchel_Medical",          basePrice=110, tags={"Container.Backpack.Satchel", "Origin.Medical", "Rarity.Uncommon"}, stockRange={min=2, max=5} },
{ item="Base.Bag_Satchel_Military",         basePrice=180, tags={"Container.Backpack.Satchel", "Origin.Military", "Rarity.Uncommon"}, stockRange={min=2, max=5} },
...
{ item="Base.Bag_SheetSlingBag",            basePrice=25, tags={"Container.Backpack.Sling", "Quality.Junk"}, stockRange={min=5, max=15} },
...
{ item="Base.Bag_RifleCaseCloth",           basePrice=20,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=2, max=5} },
{ item="Base.Bag_RifleCaseCloth2",          basePrice=20,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=2, max=5} },
{ item="Base.Bag_RifleCaseClothCamo",       basePrice=25,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=1, max=3} },
{ item="Base.Bag_ShotgunCaseCloth",         basePrice=20,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=2, max=5} },
{ item="Base.Bag_ShotgunCaseCloth2",        basePrice=20,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=2, max=5} },

-- SPECIALTY DUFFELS (Shotgun/Weapon variants)
{ item="Base.Bag_ShotgunBag",               basePrice=35,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=1, max=3} },
{ item="Base.Bag_ShotgunDblBag",            basePrice=35,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=1, max=3} },
{ item="Base.Bag_ShotgunDblSawnoffBag",     basePrice=35,  tags={"Container.Backpack.Hydration", "Weapon"}, stockRange={min=1, max=3} },
...
{ item="Base.Bag_ALICE_BeltSus_Camo",       basePrice=350, tags={"Container.Wearable.Tactical", "Origin.Military", "Rarity.Rare"}, stockRange={min=0, max=1} },
{ item="Base.Bag_ALICE_BeltSus_Green",      basePrice=350, tags={"Container.Wearable.Tactical", "Origin.Military", "Rarity.Rare"}, stockRange={min=0, max=1} },
{ item="Base.Bag_ChestRig",                 basePrice=300, tags={"Container.Wearable.Tactical", "Origin.Military", "Rarity.Rare"}, stockRange={min=0, max=1} },
{ item="Base.Bag_ChestRig_Tarp",            basePrice=120, tags={"Container.Wearable.Tactical", "Theme.Survival", "Rarity.Uncommon"}, stockRange={min=1, max=2} },
...
{ item="Base.Humidor",                      basePrice=15,  tags={"Luxury.Decor"}, stockRange={min=1, max=3} },
...
{ item="Base.Bag_LaundryLinen",             basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=15} },
{ item="Base.Bag_LaundryHospital",          basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=15} },

-- Small Totes & Baskets
{ item="Base.Tote",                         basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.Tote_Bags",                    basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.Tote_Clothing",                basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.Bag_Dancer",                   basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.Bag_BirthdayBasket",           basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=2, max=8} },
{ item="Base.Bag_GardenBasket",             basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=2, max=8} },
{ item="Base.Bag_BowlingBallBag",           basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=2, max=8} },
...
{ item="Base.Plasticbag_Bags",              basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.Plasticbag_Clothing",          basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.GroceryBag1",                  basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.GroceryBag2",                  basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.GroceryBag3",                  basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.GroceryBag4",                  basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.GroceryBag5",                  basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.GroceryBagGourmet",            basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.PaperBag",                     basePrice=0.2, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.Paperbag_Jays",                basePrice=0.2, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.Paperbag_Spiffos",             basePrice=0.2, tags={"Container.Sack.Junk"}, stockRange={min=10, max=50} },
{ item="Base.TakeoutBox_Chinese",           basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.TakeoutBox_Styrofoam",         basePrice=0.5, tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.ProduceBox_ExtraSmall",        basePrice=1,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.ProduceBox_Small",             basePrice=1,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.ProduceBox_Medium",            basePrice=1,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.ProduceBox_Large",             basePrice=1,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.ProduceBox_ExtraLarge",        basePrice=1,   tags={"Container.Sack.Junk"}, stockRange={min=5, max=20} },
{ item="Base.Handbag",                      basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=2, max=10} },
{ item="Base.Purse",                        basePrice=5,   tags={"Container.Sack.Junk"}, stockRange={min=2, max=10} },
})
