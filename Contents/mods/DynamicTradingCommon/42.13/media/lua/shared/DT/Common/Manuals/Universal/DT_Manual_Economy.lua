...
--   "chapters": [
--     { "id": "pricing", "title": "Art of the Deal", "description": "Understanding how your loot turns into coin." },
--     { "id": "specialization", "title": "Expertise & Connections", "description": "Finding the right buyer for your specialized gear." }
--   ],
--   "pages": [
--     {
