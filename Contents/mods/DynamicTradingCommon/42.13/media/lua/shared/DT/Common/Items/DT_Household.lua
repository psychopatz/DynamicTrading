...
{ item="Base.Pencil",           basePrice=2,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=10, max=50} },
{ item="Base.Pen",              basePrice=2,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=10, max=50} }, -- Black
{ item="Base.BluePen",          basePrice=2,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=5, max=20} },
{ item="Base.RedPen",           basePrice=2,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=5, max=20} },
{ item="Base.GreenPen",         basePrice=2,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=5, max=20} },
{ item="Base.Eraser",           basePrice=5,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=5, max=20} },
{ item="Base.Crayons",          basePrice=15, tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=5, max=20} },

-- Premium Writing
{ item="Base.PenMultiColor",    basePrice=10, tags={"Junk.Household.Scholastic", "Rarity.Uncommon"}, stockRange={min=1, max=5} }, -- 4 colors in 1
{ item="Base.PenFancy",         basePrice=25, tags={"Junk.Household.Scholastic", "Quality.Luxury", "Rarity.Rare"}, stockRange={min=1, max=3} }, -- Fountain Pen

-- Collector Items (Spiffo)
{ item="Base.PenSpiffo",        basePrice=50, tags={"Junk.Household.Scholastic", "Quality.Luxury", "Rarity.Rare"}, stockRange={min=0, max=2} },
{ item="Base.PencilSpiffo",     basePrice=50, tags={"Junk.Household.Scholastic", "Quality.Luxury", "Rarity.Rare"}, stockRange={min=0, max=2} },

-- Markers (Bold map markings)
{ item="Base.MarkerBlack",      basePrice=8,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=2, max=10} },
{ item="Base.MarkerBlue",       basePrice=8,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=2, max=10} },
{ item="Base.MarkerRed",        basePrice=8,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=2, max=10} },
{ item="Base.MarkerGreen",      basePrice=8,  tags={"Junk.Household.Scholastic", "Rarity.Common"}, stockRange={min=2, max=10} },
...
{ item="Base.Clipboard",        basePrice=10, tags={"Junk.Household.Scholastic", "Quality.Junk"}, stockRange={min=1, max=5} },
{ item="Base.CorrectionFluid",  basePrice=5,  tags={"Junk.Household.Scholastic", "Quality.Junk"}, stockRange={min=1, max=5} },
...
{ item="Base.ClosedUmbrellaBlack",  basePrice=45, tags={"Weapon.Melee.Spear", "Quality.Junk"}, stockRange={min=1, max=5} },
...
{ item="Base.Broom_Twig",           basePrice=5,  tags={"Resource.Material.Raw", "Quality.Junk"}, stockRange={min=1, max=5} },
})
