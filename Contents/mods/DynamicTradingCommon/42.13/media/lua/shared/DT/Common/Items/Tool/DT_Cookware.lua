...
DynamicTrading.RegisterBatch({
    ...
    { item="Base.GridlePan", basePrice=35, tags={"Tool.Cookware", "Rarity.Common", "Tool.Fragile"}, stockRange={min=0, max=8} },
    { item="Base.TinOpener_Old", basePrice=34, tags={"Tool.Cookware", "Rarity.Common", "Tool.Fragile"}, stockRange={min=0, max=8} },
    ...
    { item="Base.BottleOpener", basePrice=20, tags={"Tool.Cookware", "Rarity.Rare"}, stockRange={min=0, max=11} },
    { item="Base.BottleOpener_Keychain", basePrice=20, tags={"Tool.Cookware", "Rarity.Rare"}, stockRange={min=0, max=22} },
    { item="Base.CheeseGrater", basePrice=25, tags={"Tool.Cookware", "Rarity.Rare"}, stockRange={min=0, max=4} },
    { item="Base.Corkscrew", basePrice=22, tags={"Tool.Cookware", "Rarity.Rare"}, stockRange={min=0, max=11} },
    ...
    { item="Base.Kettle_Copper", basePrice=33, tags={"Tool.Cookware", "Rarity.Rare", "Origin.Police"}, stockRange={min=0, max=3} },
    ...
    { item="Base.P38", basePrice=20, tags={"Tool.Cookware", "Rarity.Rare"}, stockRange={min=0, max=22} },
    ...
    { item="Base.SaucepanCopper", basePrice=46, tags={"Tool.Cookware", "Rarity.Rare", "Origin.Police", "Tool.Fragile"}, stockRange={min=0, max=3} },
    { item="Base.SkewersWooden", basePrice=20, tags={"Tool.Cookware", "Rarity.Rare"}, stockRange={min=0, max=11} },
    ...
    { item="Base.WoodenFork", basePrice=23, tags={"Tool.Cookware", "Rarity.Rare", "Tool.Fragile"}, stockRange={min=0, max=11} },
    { item="Base.WoodenSpoon", basePrice=23, tags={"Tool.Cookware", "Rarity.Rare", "Tool.Fragile"}, stockRange={min=0, max=11} },
})
