...
DynamicTrading.RegisterBatch({
    ...
    { item="Base.AluminumScrap",     tags={"Resource.Material.Metal", "Quality.Junk"},  basePrice=10, stockRange={min=5, max=15} }, -- Worth: 5.0
    { item="Base.BrassIngot",        tags={"Resource.Material.Metal", "Rarity.Uncommon"}, basePrice=160, stockRange={min=1, max=4} }, -- Worth: 80.0
    { item="Base.BrassScrap",        tags={"Resource.Material.Metal", "Quality.Junk"},  basePrice=20, stockRange={min=5, max=20} },
    ...
    { item="Base.CopperScrap",       tags={"Resource.Material.Metal", "Quality.Junk"},  basePrice=16, stockRange={min=5, max=20} },
    ...
    { item="Base.IronScrap",         tags={"Resource.Material.Metal", "Quality.Junk"},  basePrice=24, stockRange={min=10, max=30} },
    ...
    { item="Base.Claybag",           tags={"Resource.Material.Industrial", "Quality.Standard", "Rarity.Common"}, basePrice=60, stockRange={min=2, max=8} },
    ...
    -- FABRICS
    { item="Base.FabricRoll_Cotton", tags={"Resource.Textile", "Rarity.Uncommon"}, basePrice=240, stockRange={min=1, max=3} }, -- Worth: 120.0
    { item="Base.Sheet",             tags={"Resource.Textile", "Rarity.Common"},   basePrice=30,  stockRange={min=5, max=20} }, -- Worth: 15.0
    { item="Base.RippedSheets",      tags={"Resource.Textile", "Quality.Junk"},    basePrice=4,   stockRange={min=20, max=100} },
    ...
    { item="Base.LeatherStrips",     tags={"Resource.Textile", "Rarity.Common"},  basePrice=10,  stockRange={min=10, max=50} }, -- Worth: 5.0
    { item="Base.Leather_Crude_Large",tags={"Resource.Textile", "Theme.Survival"}, basePrice=120, stockRange={min=1, max=4} }, -- Worth: 60.0
    { item="Base.CowHide",           tags={"Resource.Textile", "Rarity.Rare"},    basePrice=240, stockRange={min=1, max=3} }, -- Worth: 120.0
    { item="Base.RabbitLeather_Full",tags={"Resource.Textile", "Rarity.Common"},  basePrice=50,  stockRange={min=2, max=8} }, -- Worth: 25.0
    ...
    { item="Base.DuctTape",          tags={"Resource.Component", "Rarity.Uncommon"}, basePrice=170, stockRange={min=1, max=5} }, -- Worth: 85.0
    { item="Base.Glue",              tags={"Resource.Component", "Rarity.Common"},   basePrice=70,  stockRange={min=2, max=8} }, -- Worth: 35.0
    { item="Base.Woodglue",          tags={"Resource.Component", "Rarity.Uncommon"}, basePrice=130, stockRange={min=1, max=5} }, -- Worth: 65.0
    { item="Base.Epoxy",             tags={"Resource.Component", "Rarity.Uncommon"}, basePrice=150, stockRange={min=1, max=4} }, -- Worth: 75.0
    
    -- CONSTRUCTION
    { item="Base.NailsBox",          tags={"Resource.Component", "Rarity.Uncommon"}, basePrice=360, stockRange={min=2, max=10} }, -- Worth: 180.0
    { item="Base.Nails",             tags={"Resource.Component", "Rarity.Common"},   basePrice=4,   stockRange={min=50, max=200} }, -- Worth: 2.0
    { item="Base.Wire",              tags={"Resource.Component", "Rarity.Common"},   basePrice=70,  stockRange={min=2, max=8} }, -- Worth: 35.0
    { item="Base.PropaneTank",       tags={"Resource.Fuel", "Rarity.Rare"},          basePrice=500, stockRange={min=1, max=3} }, -- Worth: 250.0
    { item="Base.WeldingRods",       tags={"Resource.Component", "Rarity.Uncommon"}, basePrice=120, stockRange={min=2, max=10} }, -- Worth: 60.0
