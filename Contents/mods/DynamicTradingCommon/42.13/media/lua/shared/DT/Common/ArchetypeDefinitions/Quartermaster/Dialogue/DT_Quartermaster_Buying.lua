...
DynamicTrading.Dialogue.Archetypes["Quartermaster"].Buying = {
    Generic = {
        "A standard issue choice! I'll package the {item} with care. {price} received.",
    ...
    NoCash = {
        "You're in the red, {player}. Even quartermasters need cash. Need more than {price}.",
