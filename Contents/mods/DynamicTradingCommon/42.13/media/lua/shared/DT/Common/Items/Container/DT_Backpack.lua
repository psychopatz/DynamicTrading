...
DynamicTrading.RegisterBatch({
    ...
    { item="Base.Bag_ALICEpack", basePrice=260, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=2} },
    { item="Base.Bag_ALICEpack_Army", basePrice=299, tags={"Container.Bag.Backpack", "Rarity.Rare", "Origin.Militia", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=2} },
    { item="Base.Bag_ALICEpack_DesertCamo", basePrice=260, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=2} },
    ...
    { item="Base.Bag_BigHikingBag", basePrice=221, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=4} },
    { item="Base.Bag_BigHikingBag_Travel", basePrice=221, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=4} },
    ...
    { item="Base.Bag_CraftedFramepack_Large", basePrice=204, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=2} },
    { item="Base.Bag_CraftedFramepack_Large2", basePrice=236, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=2} },
    { item="Base.Bag_CraftedFramepack_Large3", basePrice=288, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=2} },
    ...
    { item="Base.Bag_HikingBag_Travel", basePrice=205, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=4} },
    ...
    { item="Base.Bag_Military", basePrice=212, tags={"Container.Bag.Backpack", "Rarity.Rare", "Origin.Militia", "Container.Capacity.Medium", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=4} },
    { item="Base.Bag_NormalHikingBag", basePrice=205, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=4} },
    { item="Base.Bag_Police", basePrice=199, tags={"Container.Bag.Backpack", "Rarity.Rare", "Origin.Police", "Container.Capacity.Medium", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=4} },
    ...
    { item="Base.Bag_Schoolbag_Medical", basePrice=173, tags={"Container.Bag.Backpack", "Rarity.Rare", "Origin.Clinical", "Container.Capacity.Medium", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=4} },
    ...
    { item="Base.Bag_Sheriff", basePrice=199, tags={"Container.Bag.Backpack", "Rarity.Rare", "Origin.Police", "Container.Capacity.Medium", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=4} },
    ...
    { item="Base.Bag_SurvivorBag", basePrice=260, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.High", "Container.Wearable"}, stockRange={min=0, max=2} },
    ...
    { item="Base.Bag_TarpFramepack_Large", basePrice=199, tags={"Container.Bag.Backpack", "Rarity.Rare", "Container.Capacity.High", "Container.WeightReduction.Medium", "Container.Wearable"}, stockRange={min=0, max=2} },
