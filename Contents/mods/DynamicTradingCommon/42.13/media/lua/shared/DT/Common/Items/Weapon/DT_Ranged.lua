...
DynamicTrading.RegisterBatch({
    ...
    { item="Base.Revolver", basePrice=51, tags={"Weapon.Firearm.Ranged", "Rarity.Common"}, stockRange={min=2, max=10} },
    ...
    { item="Base.Revolver_Short", basePrice=54, tags={"Weapon.Firearm.Ranged", "Rarity.Common"}, stockRange={min=2, max=10} },
