...
local function getTraderStockEntry(traderUUID, itemFullType)
...
local function getFixedStockPrice(traderUUID, itemFullType)
    local entry = getTraderStockEntry(traderUUID, itemFullType)
...
local function resolveBuyPriceWithHeat(traderUUID, itemFullType, customData, globalHeat, verbose, skipEvents)
    ...
    local fixedPrice = getFixedStockPrice(traderUUID, itemFullType)
