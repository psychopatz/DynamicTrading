...
--       "description": "Learning to tell a local riot from a global plague."
--     },
--     {
--       "id": "mechanics",
--       "title": "The Lottery of Fate",
--       "description": "How the world changes while you sleep."
--     }
--   ],
--   "pages": [
--     {
...
--         {
--           "type": "paragraph",
--           "text": "Meta events are world-altering. A 'State-wide Shortage' or a 'Plague Outbreak' affects every merchant from Rosewood to West Point. These aren't just market blips; they are new realities you must adapt to."
--         },
--         {
--           "type": "heading",
--           "id": "seasonal-events",
--           "level": 1,
--           "text": "The Turning Seasons"
--         },
--         {
--           "type": "paragraph",
--           "text": "The seasons wait for no one. Expect 'Winter Scarcity' to make food a luxury when the snow falls, and 'Summer Surplus' to make basics cheap when the sun is out. Plan your stockpile months in advance."
--         }
--       ]
--     },
--     {
...
--         {
--           "type": "heading",
--           "id": "the-stacking-rule",
--           "level": 1,
--           "text": "When Disasters Overlap"
--         },
--         {
--           "type": "paragraph",
--           "text": "Disasters don't just add up; they multiply. If a 'Plague' doubles medical prices and a local 'Medical Raid' doubles them again, you're looking at a 400% price hike. Overlapping events can turn a slightly expensive item into a king's ransom overnight."
--         },
--         {
--           "type": "image",
...
--           "tone": "warn",
--           "title": "Survival Tip",
--           "text": "Always check your Faction Intelligence window. If the 'Market Breakdown' shows multiple red multipliers, it's time to sell your stockpile and run for the hills."
--         }
--       ]
--     },
--     {
...
--           "id": "human-cost",
--           "level": 1,
--           "text": "Casualties and Starvation"
--         },
--         {
--           "type": "paragraph",
--           "text": "Events aren't just numbers on a screen. Factions lose people during a 'Civil War' or a 'Plague'. If you see a faction's population dropping, it's because the events are taking their toll."
--         },
--         {
--           "type": "paragraph",
