...
DynamicTrading.RegisterBatch({
    ...
    -- ==========================================================
    { item="Base.Axe",                tags={"Weapon.Melee.Axe", "Tool.Resource.Wood", "Rarity.Common"}, basePrice=180, stockRange={min=1, max=5} }, -- Worth: 15.0
    { item="Base.Axe_Old",            tags={"Weapon.Melee.Axe", "Tool.Resource.Wood", "Quality.Junk"},  basePrice=120, stockRange={min=1, max=3} }, -- Worth: 10.0
    { item="Base.WoodAxe",            tags={"Weapon.Melee.Axe", "Tool.Resource.Wood", "Rarity.Uncommon"}, basePrice=300, stockRange={min=1, max=3} }, -- Worth: 25.0
    { item="Base.WoodAxeForged",      tags={"Weapon.Melee.Axe", "Tool.Resource.Wood", "Rarity.Rare"},     basePrice=420, stockRange={min=0, max=2} }, -- Worth: 35.0
    { item="Base.PickAxe",            tags={"Weapon.Melee.Axe", "Tool.Mining", "Rarity.Uncommon"},        basePrice=240, stockRange={min=1, max=3} }, -- Worth: 20.0
    { item="Base.PickAxeForged",      tags={"Weapon.Melee.Axe", "Tool.Mining", "Rarity.Rare"},            basePrice=360, stockRange={min=0, max=2} }, -- Worth: 30.0
    ...
    { item="Base.HandAxe_Old",        tags={"Weapon.Melee.Axe", "Tool.Resource.Wood", "Quality.Junk"},  basePrice=60,  stockRange={min=2, max=6} },  -- Worth: 5.0
    ...
    -- ==========================================================
    -- Axes & Cleavers
    { item="Base.Axe_ScrapCleaver",       tags={"Weapon.Melee.Axe", "Origin.Scavenger", "Quality.Junk"}, basePrice=60, stockRange={min=1, max=3} },
    { item="Base.Axe_Sawblade",           tags={"Weapon.Melee.Axe", "Origin.Scavenger", "Quality.Junk"}, basePrice=120, stockRange={min=0, max=2} },
    { item="Base.Axe_Sawblade_Hatchet",   tags={"Weapon.Melee.Axe", "Origin.Scavenger", "Quality.Junk"}, basePrice=85, stockRange={min=1, max=3} },
    { item="Base.MeatCleaver_Scrap",      tags={"Weapon.Melee.Axe", "Origin.Scavenger", "Quality.Junk"}, basePrice=35, stockRange={min=1, max=4} },
    
    -- Blunts (Cudgels/Bats/Pipes)
    { item="Base.TableLeg_Sawblade",         tags={"Weapon.Melee.ShortBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=45, stockRange={min=0, max=2} },
    { item="Base.BaseballBat_RailSpike",     tags={"Weapon.Melee.Blunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=75, stockRange={min=0, max=2} },
    { item="Base.BaseballBat_Sawblade",      tags={"Weapon.Melee.Blunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=95, stockRange={min=0, max=2} },
    { item="Base.ShortBat_RailSpike",        tags={"Weapon.Melee.ShortBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=45, stockRange={min=1, max=3} },
    { item="Base.ShortBat_Sawblade",         tags={"Weapon.Melee.ShortBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=55, stockRange={min=1, max=3} },
    { item="Base.FieldHockeyStick_Sawblade", tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=55, stockRange={min=0, max=2} },
    { item="Base.MetalPipe_Railspike",       tags={"Weapon.Melee.ShortBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=55, stockRange={min=0, max=2} },
    { item="Base.TreeBranch_Railspike",      tags={"Weapon.Melee.ShortBlunt", "Theme.Survival", "Quality.Junk"}, basePrice=25, stockRange={min=1, max=4} },
    
    -- Long Handles
    { item="Base.LongHandle_Railspike",   tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=45,  stockRange={min=0, max=3} },
    { item="Base.LongHandle_Sawblade",    tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=50,  stockRange={min=0, max=3} },
    { item="Base.LongHandle_Can",         tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=55,  stockRange={min=1, max=5} },
    { item="Base.LongHandle_Brake",       tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=85,  stockRange={min=0, max=3} },
    { item="Base.LongHandle_Nails",       tags={"Weapon.Melee.LongBlunt", "Theme.Survival", "Quality.Junk"},  basePrice=45,  stockRange={min=1, max=5} },
    { item="Base.LongHandle_RakeHead",    tags={"Weapon.Melee.LongBlunt", "Tool.Farmer", "Quality.Junk"},     basePrice=65,  stockRange={min=1, max=4} },

    -- Heavy Scrap (Brake Discs & Mauls)
    { item="Base.ScrapWeapon_Brake",      tags={"Weapon.Melee.HeavyBlunt", "Origin.Scavenger", "Rarity.Uncommon"}, basePrice=110, stockRange={min=0, max=2} },
    { item="Base.Cudgel_Brake",           tags={"Weapon.Melee.HeavyBlunt", "Origin.Scavenger", "Rarity.Uncommon"}, basePrice=125, stockRange={min=0, max=1} },
    { item="Base.Cudgel_Sawblade",        tags={"Weapon.Melee.HeavyBlunt", "Origin.Scavenger", "Rarity.Uncommon"}, basePrice=115, stockRange={min=0, max=1} },
    { item="Base.Cudgel_SpadeHead",       tags={"Weapon.Melee.HeavyBlunt", "Origin.Scavenger", "Rarity.Uncommon"}, basePrice=105, stockRange={min=0, max=1} },
    { item="Base.Plank_Brake",            tags={"Weapon.Melee.Blunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=65, stockRange={min=0, max=3} },
    { item="Base.Plank_Sawblade",         tags={"Weapon.Melee.Blunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=55, stockRange={min=0, max=3} },
    ...
    { item="Base.ScrapMaul",          tags={"Weapon.Melee.HeavyBlunt", "Quality.Junk"},        basePrice=150, stockRange={min=0, max=3} }, -- Worth: 12.5
    { item="Base.StoneMaul",          tags={"Weapon.Melee.HeavyBlunt", "Theme.Survival"},      basePrice=72,  stockRange={min=1, max=5} }, -- Worth: 6.0
    
    -- Bucket & Kettle Maces
    { item="Base.BucketMace_Metal",   tags={"Weapon.Melee.HeavyBlunt", "Quality.Junk"}, basePrice=120, stockRange={min=0, max=3} }, -- Worth: 10.0
    { item="Base.BucketMace_Wood",    tags={"Weapon.Melee.HeavyBlunt", "Quality.Junk"}, basePrice=96,  stockRange={min=0, max=3} },
    { item="Base.KettleMace_Metal",   tags={"Weapon.Melee.HeavyBlunt", "Quality.Junk"}, basePrice=144, stockRange={min=0, max=3} },
    { item="Base.KettleMace_Wood",    tags={"Weapon.Melee.HeavyBlunt", "Quality.Junk"}, basePrice=120, stockRange={min=0, max=3} },
    { item="Base.BarBell",            tags={"Weapon.Melee.HeavyBlunt", "Quality.Luxury"}, basePrice=300, stockRange={min=0, max=3} }, -- Worth: 25.0
    ...
    { item="Base.BaseballBat_Can",            tags={"Weapon.Melee.Blunt", "Quality.Junk"},      basePrice=108, stockRange={min=0, max=4} }, -- Worth: 9.0
    { item="Base.BaseballBat_ScrapSheet",     tags={"Weapon.Melee.Blunt", "Quality.Junk"},      basePrice=156, stockRange={min=0, max=3} }, -- Worth: 13.0
    ...
    { item="Base.LeafRake",           tags={"Weapon.Melee.LongBlunt", "Tool.Farmer", "Quality.Junk"}, basePrice=30, stockRange={min=1, max=4} },
    { item="Base.EntrenchingTool",    tags={"Weapon.Melee.ShortBlunt", "Tool.Military", "Rarity.Common"},basePrice=75, stockRange={min=1, max=3} },
    { item="Base.ScrapWeaponGardenFork", tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=85, stockRange={min=0, max=2} },
    { item="Base.ScrapWeaponSpade",   tags={"Weapon.Melee.LongBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=80, stockRange={min=0, max=2} },
    ...
    -- ==========================================================
    { item="Base.Cudgel_ScrapSheet",      tags={"Weapon.Melee.ShortBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=125, stockRange={min=0, max=2} },
    ...
    { item="Base.Cudgel_Nails",           tags={"Weapon.Melee.ShortBlunt", "Theme.Survival", "Quality.Junk"},   basePrice=75, stockRange={min=1, max=4} },
    { item="Base.Cudgel_Railspike",       tags={"Weapon.Melee.ShortBlunt", "Origin.Scavenger", "Quality.Junk"}, basePrice=115, stockRange={min=1, max=3} },
    { item="Base.Cudgel_Spike",           tags={"Weapon.Melee.ShortBlunt", "Theme.Survival", "Quality.Junk"},   basePrice=85, stockRange={min=1, max=3} },
    ...
    { item="Base.SpearHuntingKnife",      tags={"Weapon.Melee.Spear", "Theme.Tactical", "Rarity.Uncommon"}, basePrice=160, stockRange={min=0, max=1} },
    { item="Base.SpearFightingKnife",     tags={"Weapon.Melee.Spear", "Origin.Military", "Rarity.Rare"},    basePrice=180, stockRange={min=0, max=1} },
    { item="Base.SpearLargeKnife",        tags={"Weapon.Melee.Spear", "Theme.Tactical", "Rarity.Uncommon"}, basePrice=150, stockRange={min=0, max=2} },
    { item="Base.SpearShort",             tags={"Weapon.Melee.Spear", "Origin.Scavenger", "Quality.Junk"},  basePrice=95,  stockRange={min=1, max=3} },
    { item="Base.SpearStone",             tags={"Weapon.Melee.Spear", "Theme.Survival", "Quality.Primitive"}, basePrice=65, stockRange={min=1, max=4} },
    { item="Base.SpearKnife",             tags={"Weapon.Melee.Spear", "Origin.Scavenger", "Quality.Junk"},  basePrice=85,  stockRange={min=1, max=4} },
    ...
    { item="Base.Pistol3",                tags={"Weapon.Ranged.Firearm", "Origin.Military", "Rarity.Rare"},   basePrice=950, stockRange={min=0, max=1} },
    ...
    -- Rifles
    { item="Base.AssaultRifle",           tags={"Weapon.Ranged.Firearm", "Origin.Military", "Rarity.Legendary"},basePrice=2500, stockRange={min=0, max=1} },
    { item="Base.AssaultRifle2",          tags={"Weapon.Ranged.Firearm", "Origin.Military", "Rarity.Rare"},   basePrice=1800, stockRange={min=0, max=1} },
    ...
    -- Novelty
    { item="Base.Revolver_CapGun",        tags={"Junk.Toy", "Rarity.Common"}, basePrice=10, stockRange={min=1, max=2} },
    ...
    { item="Base.PipeBomb",           tags={"Weapon.Ranged.Explosive", "Origin.Military", "Rarity.Uncommon"}, basePrice=280, stockRange={min=1, max=3} },
    { item="Base.Aerosolbomb",        tags={"Weapon.Ranged.Explosive", "Origin.Scavenger", "Rarity.Uncommon"}, basePrice=150, stockRange={min=1, max=3} },
    { item="Base.FlameTrap",          tags={"Weapon.Ranged.Explosive", "Theme.Survival", "Rarity.Rare"},      basePrice=350, stockRange={min=0, max=2} },
    { item="Base.SmokeBomb",          tags={"Weapon.Ranged.Explosive", "Origin.Military", "Rarity.Common"},    basePrice=110, stockRange={min=1, max=5} },
    { item="Base.NoiseTrap",          tags={"Weapon.Ranged.Explosive", "Origin.Scavenger", "Rarity.Common"},   basePrice=85,  stockRange={min=2, max=6} },
    ...
    { item="Base.Plank_Saw",          tags={"Weapon.Melee.LongBlunt", "Theme.Survival", "Quality.Junk"}, basePrice=35, stockRange={min=1, max=5} },
    { item="Base.LongStick",          tags={"Weapon.Melee.LongBlunt", "Theme.Survival", "Quality.Primitive"}, basePrice=12, stockRange={min=2, max=10} },
    { item="Base.LargeBranch",        tags={"Weapon.Melee.LongBlunt", "Theme.Survival", "Quality.Primitive"}, basePrice=25, stockRange={min=2, max=8} },
    { item="Base.Broom",              tags={"Weapon.Melee.LongBlunt", "Junk.Household", "Rarity.Common"}, basePrice=25, stockRange={min=1, max=5} },
    { item="Base.Mop",                tags={"Weapon.Melee.LongBlunt", "Junk.Household", "Rarity.Common"}, basePrice=30, stockRange={min=1, max=5} },
    { item="Base.Stone2",             tags={"Resource.Material.Raw", "Quality.Primitive"},  basePrice=5,  stockRange={min=5, max=15} },
    { item="Base.FlintNodule",        tags={"Resource.Material.Raw", "Theme.Survival"},      basePrice=15, stockRange={min=2, max=8} },
    { item="Base.Pen",                tags={"Junk.Household.Tool", "Rarity.Common"},        basePrice=2,  stockRange={min=5, max=10} },
    { item="Base.Pencil",             tags={"Junk.Household.Tool", "Rarity.Common"},        basePrice=2,  stockRange={min=5, max=10} },
    { item="Base.CompassGeometry",    tags={"Junk.Household.Tool", "Rarity.Uncommon"},      basePrice=15, stockRange={min=1, max=3} },
