...
DynamicTrading.RegisterBatch({
    ...
    -- [Clothing.Hands] [Rarity.Rare] (19 items)
    { item="Base.Gloves_BoxingBlue", basePrice=50, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_BoxingRed", basePrice=50, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_BurlapWrap", basePrice=27, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_DenimWrap", basePrice=37, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    ...
    { item="Base.Gloves_HuntingCamo", basePrice=46, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_LeatherGloves", basePrice=128, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_LeatherGlovesBlack", basePrice=128, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_LeatherGlovesBrown", basePrice=128, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    { item="Base.Gloves_LeatherWrap", basePrice=69, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
    ...
    { item="Base.Gloves_TarpWrap", basePrice=37, tags={"Clothing.Hands", "Rarity.Rare"}, stockRange={min=0, max=10} },
