...
{ item="Base.Razor", basePrice=15, tags={"Junk.Grooming", "Theme.Society", "Rarity.Common"}, stockRange={min=1, max=5} },
{ item="Base.Mirror", basePrice=25, tags={"Junk.Grooming", "Theme.Society", "Rarity.Common"}, stockRange={min=1, max=3} },
...
-- 3. HAIR CARE & DYES
-- =============================================================================
{ item="Base.Hairgel",          basePrice=10, tags={"Junk.Grooming", "Quality.Luxury", "Rarity.Uncommon"}, stockRange={min=2, max=8} },
{ item="Base.Hairspray2",       basePrice=15, tags={"Junk.Grooming", "Resource.Fuel.Aerosol", "Rarity.Common"},   stockRange={min=2, max=8} }, -- Tagged 'Fuel' as it is often flammable/accelerant in mods
