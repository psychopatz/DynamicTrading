...
--   "module": "v1",
--   "title": "V1 Radio Guide",
--   "description": "Mastering the airwaves to secure supplies",
...
--       "description": "Choosing the right hardware for the job."
--     },
--     {
--       "id": "interaction",
--       "title": "Establishing Contact",
--       "description": "Tuning into the hidden markets of Kentucky."
--     }
--   ],
--   "pages": [
--     {
...
--         {
--           "type": "paragraph",
--           "text": "Walking into West Point with a backpack full of gold is a death sentence. The radio lets you deal with merchants from the relative safety of your own walls. It’s the difference between a desperate sprint through the streets and a calculated business transaction."
--         },
--         {
--           "type": "image",
--           "path": "media/ui/Radio/Signal_found/1.png",
--           "caption": "A steady signal is your lifeline.",
--           "width": 220,
--           "height": 220,
...
--           "level": 1,
--           "text": "Ten Tiers of Technology"
--         },
--         {
--           "type": "paragraph",
--           "text": "From scavenged toy walkie-talkies to high-end military manpacks, there are ten tiers of gear to track down. Each upgrade offers two critical improvements:"
--         },
--         {
--           "type": "bullet_list",
--           "items": [
...
--           "id": "finding-traders",
--           "level": 1,
--           "text": "Locking the Signal"
--         },
--         {
--           "type": "paragraph",
--           "text": "Finding a trader isn't manual; it's a game of patience. Your radio constantly scans the background noise. Depending on your location and the radio's power, new signals will pop up in your 'Trader List' as they become active."
--         },
--         {
--           "type": "paragraph",
--           "text": "Once a signal is locked, you can monitor their stock in real-time. If they go offline or move out of range, the signal will fade, and you'll have to rescan."
--         }
--       ]
--     },
--     {
...
--           "id": "radio-trading",
--           "level": 1,
--           "text": "Executing the Deal"
--         },
--         {
--           "type": "paragraph",
--           "text": "Once you've tuned in, the 'Radio Interface' handles the heavy lifting. You can swap goods and currency over the airwaves. Just remember: even with a Tier 10 radio, the faction wealth and market fluctuations are still very real. If the signal is weak, checking your stock might take a moment as the interface 'polls' the remote merchant."
--         },
--         {
--           "type": "callout",
--           "tone": "warn",
--           "title": "Technical Note",
--           "text": "Always wait for the signal bars to turn green before confirming a high-value exchange. Desyncs happen in the wasteland too."
--         }
--       ]
--     }
--   ]
        ...
        pages = {
            {
                ...
                blocks = {
                    ...
                    { type = "image", path = "media/ui/Radio/Signal_found/1.png", caption = "A steady signal is your lifeline.", width = 220, height = 220 },
                },
            },
            {
                id = "radio_tiers",
